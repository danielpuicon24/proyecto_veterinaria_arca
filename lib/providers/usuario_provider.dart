...
class UsersProvider extends GetConnect {
  ...
  Future<RespuestaModel?> postRegistrarUsuario(UsuarioRegisterModel usuarioRegisterModel) async {
    try {
  ...
  Future<UsuarioModel> iniciarSesion(String email, String contrasena) async {
    ...
    try {
      if (response.statusCode == 200) {
        ...
        usuarioModel = jsonBody.map((data) => UsuarioModel.fromJson(data)).toList();
