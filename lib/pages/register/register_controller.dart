...
class RegisterController extends GetxController {
  ...
  Future<String> uploadImageFirebase(String dni, String nombre) async {
    ...
    await _reference.child('$dni$nombre.jpg').putFile(File(imageFileRegister!.path));
  ...
  Future<void> register() async {
    ...
    if (isValidForm(
      ...
      String nombreCompleto ="${name.replaceAll(RegExp(r"\s+\b|\b\s"), "")}${lastname.replaceAll(RegExp(r"\s+\b|\b\s"), "")}";
